...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "ASTRA — Scientific AI Research Laboratory" },
      {
        name: "description",
        content:
          "ASTRA is a personal scientific research console for mathematics, physics, astronomy and the universe.",
      },
      { property: "og:title", content: "ASTRA — Scientific AI Research Laboratory" },
      {
        property: "og:description",
        content: "A dark research console for mathematics, physics, astronomy and space.",
      },
